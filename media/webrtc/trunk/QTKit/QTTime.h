...
QTKIT_EXTERN const QTTime QTZeroTime												AVAILABLE_QTKIT_VERSION_7_0_AND_LATER;
QTKIT_EXTERN const QTTime QTIndefiniteTime											AVAILABLE_QTKIT_VERSION_7_0_AND_LATER;
...
QTKIT_EXTERN QTTime QTMakeTime (long long timeValue, long timeScale)				AVAILABLE_QTKIT_VERSION_7_0_AND_LATER;
QTKIT_EXTERN QTTime QTMakeTimeScaled (QTTime time, long timeScale)					AVAILABLE_QTKIT_VERSION_7_0_AND_LATER;
...
QTKIT_EXTERN NSComparisonResult QTTimeCompare (QTTime time, QTTime otherTime)		AVAILABLE_QTKIT_VERSION_7_0_AND_LATER;
...
QTKIT_EXTERN NSString *QTStringFromSMPTETime(SMPTETime time)						AVAILABLE_QTKIT_VERSION_7_2_AND_LATER;
